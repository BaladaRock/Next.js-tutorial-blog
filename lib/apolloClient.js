...
export const APP_ID = NEXT_PUBLIC_APP_ID;
let apolloClient;
...
const createApolloClient = () => {
  // Give the API endpoint for sending the request to the database
  try {
    ...
    const link = new HttpLink({ realmEndpointURI, fetch: onFetch });
